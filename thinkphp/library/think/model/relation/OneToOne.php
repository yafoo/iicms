...
abstract class OneToOne extends Relation
{
    ...
    // 关联名
    protected $relation;
    // 自定义allowField属性（Author: yusi <zhyaphoo@qq.com>）
    protected $allowField = null;
    ...
    /**
     * 自定义allowField方法（Author: yusi <zhyaphoo@qq.com>）
     * @access public
     * @param mixed     $field 字段 同官方模型allowField方法字段
     * @return this
     */
